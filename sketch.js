...
function drawDebugPanel() {
  ...
  fill(0, 200);
  noStroke();
  rect(10, 10, 250, 215, 8);

  fill(255);
  textAlign(LEFT);
  textSize(14);

  text("DEBUG PANEL", 20, 32);
  text("D - Open / Close Panel", 20, 58);
  text("1 - Jump to Level 1", 20, 83);
  text("2 - Jump to Level 2", 20, 108);
  text("3 - Jump to Level 3", 20, 133);
  text("S - Jump to Start Screen", 20, 158);
  text("W - Jump to Win Screen", 20, 183);
  text("O - Jump to Game Over", 20, 208);
